    ...
    **/
    ...
    getArticleTools: function () {
        ...
        articleTools.innerHTML =
            "<a style='color: #1856ba; font-size:1.5em;' href='#' onclick='return window.location.reload()' title='Reload original page' id='reload-page'>Back to Article</a>";
        return articleTools;
    },
    ...
    getArticleFooter: function () {
        ...
        "<div id='rdb-footer-print'>Excerpted from <cite>" + document.title + "</cite><br />" + window.location.href + "</div>"].join('');
